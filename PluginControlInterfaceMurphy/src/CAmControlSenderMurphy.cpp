...
namespace am
{
    ...
    am_Source_s CAmControlSenderMurphy::getIcoSourceData(am_domainID_t domainID)
  {
    ...
    soundProperty.type = am::SP_EXAMPLE_TREBLE;
    soundProperty.value = 0;
    sourceData.listSoundProperties.push_back(soundProperty);
    soundProperty.type = am::SP_EXAMPLE_MID;
    soundProperty.value = 0;
    sourceData.listSoundProperties.push_back(soundProperty);
  ...
  am_Error_e CAmControlSenderMurphy::getConnectionFormatChoice(const am_sourceID_t sourceID, const am_sinkID_t sinkID, const am_Route_s listRoute, const std::vector<am_ConnectionFormat_e> listPossibleConnectionFormats, std::vector<am_ConnectionFormat_e> & listPrioConnectionFormats)
  {
    AM_UNUSED(sourceID);
    AM_UNUSED(sinkID);
    AM_UNUSED(listRoute);
  ...
  am_Error_e CAmControlSenderMurphy::hookSystemUpdateSink(const am_sinkID_t sinkID, const am_sinkClass_t sinkClassID, const std::vector<am_SoundProperty_s>& listSoundProperties, const std::vector<am_ConnectionFormat_e>& listConnectionFormats, const std::vector<am_MainSoundProperty_s>& listMainSoundProperties)
  {
    AM_UNUSED(sinkID);
  ...
  am_Error_e CAmControlSenderMurphy::hookSystemUpdateGateway(const am_gatewayID_t gatewayID, const std::vector<am_ConnectionFormat_e>& listSourceConnectionFormats, const std::vector<am_ConnectionFormat_e>& listSinkConnectionFormats, const std::vector<bool>& convertionMatrix)
  {
    AM_UNUSED(gatewayID);
